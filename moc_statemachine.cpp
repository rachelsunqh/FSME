...
QT_INIT_METAOBJECT const QMetaObject StateMachine::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_StateMachine.data,
...
void *StateMachine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QEnableSharedFromThis<StateMachine>"))
        return static_cast< QEnableSharedFromThis<StateMachine>*>(this);
